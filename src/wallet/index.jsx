...
function AppWallet() {
	...
	useEffect(() => {
        if (profile.switchwallet_address != null || profile.switchwallet_address != '' ) {
	...
	return (
		<Style>
			<h1>{data.amountInAppWallet != null? data.amountInAppWallet:0} USDT</h1>
			<div className="currency">
				<img src={usdtLogo} alt="" />
				<p>USDT</p>

			</div>
			<p style={{fontSize:13}}>{profile != undefined ? profile.switchwallet_address: null}</p>
